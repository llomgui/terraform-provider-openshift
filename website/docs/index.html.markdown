---
layout: "openshift"
page_title: "Provider: Openshift"
sidebar_current: "docs-openshift-index"
description: |-
  The Openshift provider is used to interact with the resources supported by Openshift. The provider needs to be configured with the proper credentials before it can be used.
---
...
The Openshift provider is only compatible with 3.11 version. 

## Authentication

There are generally two ways to configure the Openshift provider.
...
```
oc config set-context default-system \
